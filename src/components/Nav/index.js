        ...
        <div className="nav-wrapper">
         ...
         <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
            <ul className="right hide-on-med-and-down">
                    ...
                    <li><a href="#modal4" className="modal-trigger hide"><i id="viewicon" className="material-icons hide">view_module</i></a></li>
...
<ul class="sidenav" id="mobile-demo">
                    ...
                    <li><a href="#modal4" className="modal-trigger hide"><i id="viewiconmobile"className="material-icons">view_module</i>Mis anuncios</a></li>
