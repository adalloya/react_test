...
<ul class="sidenav" id="mobile-demo">
                    ...
                    <li><a href="hola" id="number" className="waves-effect waves-light btn-large banner">0 Articulos en venta</a></li>
                    <li><a href="hola" id="number1" className="waves-effect waves-light btn-large watchers banner">0 Personas comprando</a></li>
                    <li><a href="hola" id="number2" className="waves-effect waves-light btn-large watchers banner">0 Usuarios registrados</a></li>
  </ul>
  </div>
